...
//        itemTextView.setTextSize(TypedValue.COMPLEX_UNIT_PX, context.getResources().getDimension(R.dimen.menu_text_size));
       ...
       // itemTextView.setTextAppearance(context, menuItem.getMenuTextAppearanceStyle() >0 ? menuItem.getMenuTextAppearanceStyle():R.style.TextView_DefaultStyle);
        return itemTextView;
    }
    ...
    public static View getDivider(Context context, MenuObject menuItem) {
        ...
        dividerView.setBackgroundColor(android.graphics.Color.parseColor("#CAE6F7"));
        return dividerView;
    }
